...
def parse_arguments():
    ...
    parser.add_argument('--main-database-name', type=str, default="test")
...
if __name__ == '__main__':
    ...
    wl = workload_dbms(workload_path=args.workload_path, queries=_work_load, database_name=args.main_database_name,
