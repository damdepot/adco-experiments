...
exp_path="$(pwd)"
rewrite_path="${exp_path}/ADCo-results/Decompile/${dbms}/${dataset}-${llm_model}"
output_path_verify="${exp_path}/ADCo-results/Verify/${dbms}/${dataset}-${llm_model}-verify"
output_path_select="${exp_path}/ADCo-results/Select/${dbms}/${dataset}-${llm_model}-select"
