...
rewrite_path="${exp_path}/out/db_layer/R-Bot-results/Rewrite/${dbms}/${dataset}/${llm_model}"
output_path_verify="${exp_path}/out/db_layer/R-Bot-results/Select/${dbms}/${dataset}-${llm_model}-select"
