...
rewrite_path="${exp_path}/out/db_layer/ReSequel-results/Select/${dbms}/${dataset}-${llm_model}-select"
output_path_verify="${exp_path}/out/db_layer/ReSequel-results/Verify/${dbms}/${dataset}-${llm_model}-verify"
output_path_select="${exp_path}/out/db_layer/ReSequel-results/Select/${dbms}/${dataset}-${llm_model}-select-OR"
...
verify_log_path="${exp_path}/results/resequel/Experiment1_Verify_${dbms}_${dataset}.dat"
